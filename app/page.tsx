  ...
  return (
    <main>
      ...
      <section
        ref={ref}
        id="Landing"
        className="m-0 flex flex-col min-h-screen h-screen bg-no-repeat bg-fill bg-[url(/assets/heroBg.png)] overflow-hidden"
      >
        <div className=" h-screen w-screen bg-black bg-opacity-30">
          ...
          <div className="flex h-screen items-center justify-center">
            <motion.div
              style={{ y: textY }}
              className="text-center text-white w-4/6 space-y-8"
            >
      ...
      <section
        id="About"
        className="pt-16 flex flex-col min-h-screen h-fit bg-no-repeat bg-cover bg-[url(/assets/bg1.png)]"
      >
        <div className="p-10 h-full lg:w-1/2 absolute right-0">
          <div className="w-full mx-auto py-32 text-white">
            ...
            <div className={BlairL.className}>
              <h1 className="text-4xl lg:text-5xl font-bold mb-10">About Us</h1>
            </div>
            ...
            <div className={BlairM.className}>
              <a
                href="/about"
                className="text-yellow-500 text-base lg:text-xl underline"
              >
                MORE ABOUT US
              </a>
            </div>
      ...
      <section
        id="Product"
        className="pt-16 flex flex-col items-center justify-center min-h-screen h-fit bg-gray-300 overflow-hidden"
      >
        <div className="p-10 h-fit flex items-center text-center justify-center">
          <div className="w-full mx-auto space-y-10">
            ...
            <p className="text-xs lg:text-lg leading-loose tracking-wider px-10 lg:px-32">
              ...
              high-quality, distinctive ice for an exceptional customer
              experience.
            </p>
      ...
      <section
        id="Customer"
        className="pt-16 flex flex-col items-center justify-center min-h-screen h-fit bg-no-repeat bg-cover bg-[url(/assets/bg2.png)]"
      >
        <div className="p-10 h-fit flex items-center text-center justify-center">
          <div className="w-full mx-auto space-y-10">
            {/* Title */}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4  gap-8 ">
              ...
              <Link
                href={"/customer"}
                className="h-28 md:h-32 lg:h-40 max-w-full flex items-center justify-center hover:shadow-md rounded bg-gray-500 bg-opacity-25"
              >
        ...
        <div className="p-10 h-fit flex items-center text-center justify-center">
          <div className="w-full mx-auto space-y-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8 px-10 xl:px-32">
              ...
              <Link
                href="/gallery"
                className="h-auto max-w-full  hover:shadow-md"
              >
                <Image
